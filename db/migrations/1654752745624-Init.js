module.exports = class Init1654752745624 {
  name = 'Init1654752745624'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "swap" ("id" character varying NOT NULL, "address" text NOT NULL, "tokens" text array NOT NULL, "base_tokens" text array NOT NULL, "underlying_tokens" text array NOT NULL, "balances" numeric array NOT NULL, "tvl" numeric NOT NULL, CONSTRAINT "PK_4a10d0f359339acef77e7f986d9" PRIMARY KEY ("id"))`)
